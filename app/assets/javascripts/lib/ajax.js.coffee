CoinrootsModel = @CoinrootsModel or require('coinroots_model')
$      = CoinrootsModel.$
Model  = CoinrootsModel.Model
Queue  = $({})
...
class Singleton extends Base
  ...
  recordResponse: (options = {}) =>
    (data, status, xhr) =>
      ...
      Ajax.disable =>
        unless CoinrootsModel.isBlank(data) or @record.destroyed
