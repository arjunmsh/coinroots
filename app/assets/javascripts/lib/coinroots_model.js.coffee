...
CoinrootsModel = @CoinrootsModel= {}
module?.exports  = CoinrootsModel

CoinrootsModel.version    = '1.3.2.customizatiion'
CoinrootsModel.isArray    = isArray
CoinrootsModel.isBlank    = isBlank
CoinrootsModel.$          = $
CoinrootsModel.Events     = Events
CoinrootsModel.Log        = Log
CoinrootsModel.Module     = Module
CoinrootsModel.Model      = Model

# Global events

Module.extend.call(CoinrootsModel, Events)
