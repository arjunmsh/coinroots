An closed-source crypto currency exchange

Peatio is a closed-source crypto currency exchange implementation with the Rails framework and other cutting-edge technology.
