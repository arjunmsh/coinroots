ADMIN_EMAIL = 'admin@coinroots.dev'
...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'foo@coinroots.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@coinroots.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
